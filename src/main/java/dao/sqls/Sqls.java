...
public class Sqls {
    ...
    /** progress = 0인 예약 수 조회 */
    public static final String SELECT_TOTAL_COUNT_OF_RESERVATIONS_BEFORE_CONFIRM = "SELECT COUNT(*) FROM reservation_info WHERE progress = 0 AND departure_date >= current_date";
    /** 고객 ID를 통한 예약 수 조회 */
    ...
    /** progress = 0인 예약 조회 */
    public static final String SELECT_RESERVATION_INFOS_BEFORE_CONFIRM = "SELECT num, nation_code, applicant, price, departure_date FROM reservation_info WHERE progress = 0 AND departure_date >= current_date";
    /** 고객 ID를 통한 예약 조회 */
