...
<body>
    ...
    <main>
        <form action="/insert/exchange/rate" method="post" class="info-form">
            ...
            <table class="table table-sm ta-center">
                ...
                <tr>
                    <td>목표환율</td>
                    <td><input type="text" class="form-control ta-center input-sm" name="rate" value="${ reservationInfo.price }"/></td>
                </tr>
            </table>
